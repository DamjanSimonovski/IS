        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserCarts_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicketInUserCarts", x => new { x.TicketId, x.UserCartId });
                    table.ForeignKey(
                        name: "FK_TicketInUserCarts_Tickets_UserCartId",
                        column: x => x.UserCartId,
                        principalTable: "Tickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TicketInUserCarts_UserCarts_TicketId",
                        column: x => x.TicketId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketInUserCarts_UserCartId",
                table: "TicketInUserCarts",
                column: "UserCartId");

            migrationBuilder.CreateIndex(
                name: "IX_UserCarts_OwnerId",
                table: "UserCarts",
                column: "OwnerId",
                unique: true);
        }
